...
abstract class G2AppBase : IDisposable
{
	...
	public float ScaleX => Math.Max(0.001f, Math.Min((float)_mainForm.ClientSize.Width / ScreenSize.Width, (float)_mainForm.ClientSize.Height / ScreenSize.Height));
	public float ScaleY => ScaleX;
    public float OffsetX => (_mainForm.ClientSize.Width - ScreenSize.Width * ScaleX) / 2;
    public float OffsetY => (_mainForm.ClientSize.Height - ScreenSize.Height * ScaleY) / 2;
	...
	private void Render2D()
	{
		...
		renderTarget.Transform = System.Numerics.Matrix3x2.CreateScale(ScreenScaleX, ScreenScaleY) * System.Numerics.Matrix3x2.CreateTranslation(OffsetX, OffsetY);
